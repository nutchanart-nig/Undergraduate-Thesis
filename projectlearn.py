...
def Sorting(numberList): 
    lst2 = sorted(numberList, key=len) 
    return lst2
...
while (True):
    ...
    imgg = 'handcrop/testnum/text'+numberList[score]+'.jpg'
    frame2 = cv2.imread('handcrop/text'+numberList[score]+'.jpg')
    cv_frame.append(frame2)

    frame3 = cv2.imread('handcrop/testnum/text'+numberList[score]+'.jpg')
    cv_frame2.append(frame3)
    ...
    cv2.putText(frame, "Pass: "+str(score) ,(280,460), font, 1, (0,255,255), 2, cv2.LINE_AA)
    # cv2.putText(frame,'Pass',(280,460), font, 1.5, (0,0,255), 2, cv2.LINE_AA)
